...
func request_ExecService_StreamExec_0(ctx context.Context, marshaler runtime.Marshaler, client ExecServiceClient, req *http.Request, pathParams map[string]string) (ExecService_StreamExecClient, runtime.ServerMetadata, error) {
...
func RegisterExecServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ExecServiceServer) error {
	...
	mux.Handle("POST", pattern_ExecService_StreamExec_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterExecServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ExecServiceClient) error {
	...
	mux.Handle("POST", pattern_ExecService_StreamExec_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ExecService_StreamExec_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_ExecService_StreamExec_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
