...
func (i *InstanceClient) instanceToProto(instance *types.Instance) *generated.Instance {
	if instance == nil {
		return nil
	}
	...
	case types.InstanceStatusPending:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_PENDING
	case types.InstanceStatusCreated:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_CREATED
	case types.InstanceStatusStarting:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_STARTING
	case types.InstanceStatusRunning:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_RUNNING
	case types.InstanceStatusStopped:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_STOPPED
	case types.InstanceStatusFailed:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_FAILED
	case types.InstanceStatusExited:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_EXITED
	default:
		protoInstance.Status = generated.InstanceStatus_INSTANCE_STATUS_UNSPECIFIED
	}
